          ...
          <Drawer
            ...
            <div layout="vertical">
              <div className="header-top">
                <Title level={4}>
                  Configuración
                  <Text className="subtitle">Opciones del Dashboard.</Text>
                </Title>
              </div>

              <div className="sidebar-color">
                <Title level={5}>Color de la barra lateral</Title>
                ...
                <div className="sidebarnav-color mb-2">
                  <Title level={5}>Tipos de Barra</Title>
                  <Text>
                    Elige entre 2 diferentes tipos de barra de navegación
                  </Text>
                ...
                <div className="fixed-nav mb-2">
                  <Title level={5}>Barra de navegación fija </Title>
